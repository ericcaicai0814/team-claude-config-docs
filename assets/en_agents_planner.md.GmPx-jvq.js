...
<span class="line"><span>- [ ] 单元测试覆盖 API 逻辑</span></span></code></pre></div><hr><h2 id="使用指南" tabindex="-1">使用指南 <a class="header-anchor" href="#使用指南" aria-label="Permalink to &quot;使用指南&quot;">​</a></h2><p>调用本 agent 时，请提供：</p><ol><li><strong>用户需求</strong>：完整的功能描述</li><li><strong>项目路径</strong>：用于 ace-tool 检索上下文</li><li><strong>技术栈信息</strong>：框架、数据库、已有模块</li><li><strong>特殊约束</strong>：性能要求、兼容性、安全要求</li></ol><p>本 agent 将返回详细的 Markdown 规划文档，可直接保存到 <code>.claude/plan/功能名.md</code>。</p>`,61)])])}const g=a(l,[["render",t]]);export{k as __pageData,g as default};
