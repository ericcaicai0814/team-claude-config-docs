import{_ as a,o as n,c as e,ag as i}from"./chunks/framework.BpFM782D.js";const k=JSON.parse('{"title":"e2e","description":"","frontmatter":{},"headers":[],"relativePath":"en/commands/ecc-e2e.md","filePath":"en/commands/ecc-e2e.md"}'),p={name:"en/commands/ecc-e2e.md"};function t(l,s,r,c,h,o){return n(),e("div",null,[...s[0]||(s[0]=[i(`<h1 id="e2e" tabindex="-1">e2e <a class="header-anchor" href="#e2e" aria-label="Permalink to &quot;e2e&quot;">​</a></h1><table tabindex="0"><thead><tr><th>Field</th><th>Value</th></tr></thead><tbody><tr><td>Name</td><td>e2e</td></tr><tr><td>Description</td><td>Generate and run end-to-end tests with Playwright. Creates test journeys, runs tests, captures screenshots/videos/traces, and uploads artifacts.</td></tr><tr><td>Series</td><td>ECC</td></tr><tr><td>Source File</td><td><code>commands/e2e.md</code></td></tr></tbody></table><hr><h1 id="e2e-command" tabindex="-1">E2E Command <a class="header-anchor" href="#e2e-command" aria-label="Permalink to &quot;E2E Command&quot;">​</a></h1><p>This command invokes the <strong>e2e-runner</strong> agent to generate, maintain, and execute end-to-end tests using Playwright.</p><h2 id="what-this-command-does" tabindex="-1">What This Command Does <a class="header-anchor" href="#what-this-command-does" aria-label="Permalink to &quot;What This Command Does&quot;">​</a></h2><ol><li><strong>Generate Test Journeys</strong> - Create Playwright tests for user flows</li><li><strong>Run E2E Tests</strong> - Execute tests across browsers</li><li><strong>Capture Artifacts</strong> - Screenshots, videos, traces on failures</li><li><strong>Upload Results</strong> - HTML reports and JUnit XML</li><li><strong>Identify Flaky Tests</strong> - Quarantine unstable tests</li></ol><h2 id="when-to-use" tabindex="-1">When to Use <a class="header-anchor" href="#when-to-use" aria-label="Permalink to &quot;When to Use&quot;">​</a></h2><p>Use <code>/e2e</code> when:</p><ul><li>Testing critical user journeys (login, trading, payments)</li><li>Verifying multi-step flows work end-to-end</li><li>Testing UI interactions and navigation</li><li>Validating integration between frontend and backend</li><li>Preparing for production deployment</li></ul><h2 id="how-it-works" tabindex="-1">How It Works <a class="header-anchor" href="#how-it-works" aria-label="Permalink to &quot;How It Works&quot;">​</a></h2><p>The e2e-runner agent will:</p><ol><li><strong>Analyze user flow</strong> and identify test scenarios</li><li><strong>Generate Playwright test</strong> using Page Object Model pattern</li><li><strong>Run tests</strong> across multiple browsers (Chrome, Firefox, Safari)</li><li><strong>Capture failures</strong> with screenshots, videos, and traces</li><li><strong>Generate report</strong> with results and artifacts</li><li><strong>Identify flaky tests</strong> and recommend fixes</li></ol><h2 id="example-usage" tabindex="-1">Example Usage <a class="header-anchor" href="#example-usage" aria-label="Permalink to &quot;Example Usage&quot;">​</a></h2><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>User: /e2e Test the market search and view flow</span></span>
<span class="line"><span></span></span>
<span class="line"><span>Agent (e2e-runner):</span></span>
...
<span class="line"><span style="--shiki-light:#22863A;--shiki-dark:#85E89D;">    path</span><span style="--shiki-light:#24292E;--shiki-dark:#E1E4E8;">: </span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;">playwright-report/</span></span></code></pre></div><h2 id="best-practices" tabindex="-1">Best Practices <a class="header-anchor" href="#best-practices" aria-label="Permalink to &quot;Best Practices&quot;">​</a></h2><p><strong>DO:</strong></p><ul><li>✅ Use Page Object Model for maintainability</li><li>✅ Use data-testid attributes for selectors</li><li>✅ Wait for API responses, not arbitrary timeouts</li><li>✅ Test critical user journeys end-to-end</li><li>✅ Run tests before merging to main</li><li>✅ Review artifacts when tests fail</li></ul><p><strong>DON&#39;T:</strong></p><ul><li>❌ Use brittle selectors (CSS classes can change)</li><li>❌ Test implementation details</li><li>❌ Run tests against production</li><li>❌ Ignore flaky tests</li><li>❌ Skip artifact review on failures</li><li>❌ Test every edge case with E2E (use unit tests)</li></ul><h2 id="integration-with-other-commands" tabindex="-1">Integration with Other Commands <a class="header-anchor" href="#integration-with-other-commands" aria-label="Permalink to &quot;Integration with Other Commands&quot;">​</a></h2><ul><li>Use <code>/plan</code> to identify critical journeys to test</li><li>Use <code>/tdd</code> for unit tests (faster, more granular)</li><li>Use <code>/e2e</code> for integration and user journey tests</li><li>Use <code>/code-review</code> to verify test quality</li></ul><h2 id="related-agents" tabindex="-1">Related Agents <a class="header-anchor" href="#related-agents" aria-label="Permalink to &quot;Related Agents&quot;">​</a></h2><p>This command invokes the <code>e2e-runner</code> agent located at: <code>~/.claude/agents/e2e-runner.md</code></p><h2 id="quick-commands" tabindex="-1">Quick Commands <a class="header-anchor" href="#quick-commands" aria-label="Permalink to &quot;Quick Commands&quot;">​</a></h2><div class="language-bash vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># Run all E2E tests</span></span>
...
<span class="line"><span style="--shiki-light:#6F42C1;--shiki-dark:#B392F0;">npx</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> playwright</span><span style="--shiki-light:#032F62;--shiki-dark:#9ECBFF;"> show-report</span></span></code></pre></div>`,42)])])}const g=a(p,[["render",t]]);export{k as __pageData,g as default};
